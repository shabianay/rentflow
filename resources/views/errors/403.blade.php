...
<head>
  ...
  <title>{{ $exception->getStatusCode() ?? 403 }} - Tidak Diizinkan - {{ config('app.name') }}</title>
...
<body>
  <div class="container">
    ...
    <div class="message">Akses ditolak. Anda tidak memiliki izin untuk mengakses halaman ini.</div>
